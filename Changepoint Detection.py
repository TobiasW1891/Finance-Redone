...
Target2 = "IT"
Target3 = "HC"
key= Target1+"_"+Target2 # "CS_vs_all_corr"
print(key)

# In[2]:


data = np.load(key+".npy")
print(len(data))

# In[3]:


# Parameters for antiCPy
...
np.save(key+"_Prob_ws" + str(window_size) +'_Shift'+str(window_shift) + '.npy', cp_prob_per_window)
np.save(key +"_Config_ws"+ str(window_size)+'_Shift'+str(window_shift)   + '.npy', cp_configs_per_window)
